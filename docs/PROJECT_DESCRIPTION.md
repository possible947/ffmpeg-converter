...
- The structured selection catalog is prepared in `presets_v2.json`; GUI/CLI
   consumption is the next implementation stage. Its first-level availability
   is generated by the build system; component runtime probing remains the next
   GUI/CLI integration stage.
