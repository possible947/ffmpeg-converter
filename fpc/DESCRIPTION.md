...
This directory contains the Free Pascal implementation of the ffmpeg-converter project, providing a fully functional CLI and Lazarus/LCL GUI for **Windows only**.
...
- **Linux/macOS**: use the C/CMake implementation; Pascal builds are not supported.
